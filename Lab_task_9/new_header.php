...
<html>
    ...
    <body>
      <nav class="navbar fixed-top navbar-dark bg-info">
          ...
          <div style="font-family: 'Titillium Web', sans-serif;"><?php echo "Hi, ". $_SESSION['name'];?>&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
          <a href="log_out.php" style="padding-right:5px;" class="btn btn-outline-danger"><span><b>&nbsp;&nbsp;Logout&nbsp;&nbsp;&nbsp;&nbsp;</b></span></a></div>
      </nav>
