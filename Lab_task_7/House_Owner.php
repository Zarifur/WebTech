...
if(isset($_POST["submit"])){
    ...
    require_once "C:/xampp/htdocs/WebTech/Lab_task_7/controller/Create_Owner.php";
	...
	<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
		...
		<div style="display: flex;">
			...
			<div >
				<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
	            <div>
			      <h2>Create House Owner</h2>
			      <div  >
			        <label> 
			        <input class="test2" placeholder="Name" type="text" name="name" value="<?php echo $name;?>">
			      ...
			      <div>
			        <label> <br>
			        <input class="test2" placeholder="Email" type="text" name="email" value="<?php echo $email;?>" >
			        ...
			        <div>
			        <label> <br>
			        <input class="test2" placeholder="NID" type="text" name="nid" value="<?php echo $nid;?>" >
			        <span class="error"><?php if(!empty($nidErr)){echo $nidErr;} ?></span>
			        </label>
			        <br><br>
			      </div>
			      <div>
			        <label> <br>
			        <input class="test2" placeholder="Password" type="Password" name="pass" value="<?php echo $pass;?>" >
			        <span class="error"><?php if(!empty($passErr)){echo $passErr;}?></span>
			        </label>
			        <br><br>
			      </div>
			      <div>
			        <label> <br>
			        <input class="test2" placeholder="Retype Password" type="Password" name="pass2" value="<?php echo $pass2;?>" >
			        <span class="error"><?php  if(!empty($passErr)){echo $passErr;}?></span>
			        </label>
			        <br><br>
			      </div>
